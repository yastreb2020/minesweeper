...
namespace QuasiGaame
{
    class Program
    {
        ...
        static void Move(string[,] field, int coorI, int coorJ, int lastCoorI, int lastCoorJ)
        {
        ...
        */
        ...
        /// <param name="m"></param>
        /// <param name="b"></param>
        static string[,] CreateField(int n, int m)
        {
        ...
        /// <param name="i"></param>
        /// <param name="j"></param>
        static void UpdateField(string[,] field)
        {
            Console.Clear();
        ...
        static void CreateGame(string[,] field, int b)
        {
            int rows = field.GetUpperBound(0) + 1;
            int columns = field.Length / rows;
